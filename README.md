...
### [Group Database Project](https://github.com/SeanRourke/Group-Database-Project)
Project simulating operations of a pharmacy's database.

**Tech stack:** HTML, CSS, PHP, JavaScript, SQL

---

### [Java Database Project](https://github.com/SeanRourke/2nd-Year-Java-Database-Project)
Project simulating operations of a company's database using java.

**Tech stack:** Java, SQL

---

### [Python Textual Project](https://github.com/SeanRourke/Python-Textual-Project)
Project displaying data using textual in python.

**Tech stack:** Python

---

### [Endless Runner Game](https://github.com/SeanRourke/Endless-Runner)
An endless runner game written in assembly code.

**Tech stack:** Assembly code, EASy68K
